...
SECRET_KEY = "django-insecure-p4)bq_c-rj35zw-bvc9wk%j-m^#$k$91aode(t30y=!*bwd10g"
...
MIDDLEWARE = [
    ...
    # Thread-local middleware to make request/user available to audit signal handlers
    "tracker.middleware.ThreadLocalUserMiddleware",
